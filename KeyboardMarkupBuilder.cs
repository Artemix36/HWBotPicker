...
namespace HW_picker_bot
{
    abstract class InlineKeyBoardBuilder
    {
        ...
        public abstract List<List<InlineKeyboardButton>> CreateKeyboardButtons(Comparasign[] phoneComparisons, int page_now);
    ...
    {
        public override List<List<InlineKeyboardButton>> CreateKeyboardButtons(Comparasign[] phoneComparisons, int page_now)
        {
